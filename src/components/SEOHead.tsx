...
export const SEOHead: React.FC<SEOProps> = ({ pageId, title, description }) => {
  ...
  useEffect(() => {
    ...
    setMetaTag('meta[property="og:image"]', 'property', 'og:image', `${SITE_URL}/app-icon-1024.png`);
    ...
    setMetaTag('meta[name="twitter:image"]', 'name', 'twitter:image', `${SITE_URL}/app-icon-1024.png`);
